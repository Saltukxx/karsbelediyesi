...
const ISLEM_LABELS: Record<string, string> = {
  ...
  BAKIM_GUNCELLE: "Bakım güncellendi",
  BAKIM_SIL: "Bakım silindi",
  YAKIT_OLUSTUR: "Yakıt kaydı",
  YAKIT_GUNCELLE: "Yakıt güncellendi",
  YAKIT_SIL: "Yakıt silindi",
  MALZEME_OLUSTUR: "Malzeme oluşturuldu",
  MALZEME_GUNCELLE: "Malzeme güncellendi",
  MALZEME_PASIFE_AL: "Malzeme pasife alındı",
  STOK_HAREKET_OLUSTUR: "Stok hareketi",
  STOK_HAREKET_SIL: "Stok hareketi silindi",
  ...
  PERSONEL_GUNLUK_GUNCELLE: "Personel günlük güncellendi",
  PERSONEL_GUNLUK_SIL: "Personel günlük silindi",
  ARAC_GUNLUK_OLUSTUR: "Araç günlük kaydı",
  ARAC_GUNLUK_GUNCELLE: "Araç günlük güncellendi",
  ARAC_GUNLUK_SIL: "Araç günlük silindi",
  ARAC_HURDAYA: "Araç hurdaya ayrıldı",
  MAHALLE_GUNCELLE: "Mahalle güncellendi",
  ARAC_CINSI_GUNCELLE: "Araç cinsi güncellendi",
  TEMIZLIK_OPERASYON_OLUSTUR: "Temizlik operasyonu",
  TEMIZLIK_OPERASYON_SIL: "Temizlik operasyonu silindi",
